...
#ifdef S_MP_MUL_TOOM_9_C
/* LibTomMath, multiple-precision integer library -- Tom St Denis */
/* SPDX-License-Identifier: Unlicense */

mp_err s_mp_mul_toom_9(const mp_int *a, const mp_int *b,  mp_int *c)
{
   mp_int S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13, S14, S15, S16, S17, t;
   mp_int a0, a1, a2, a3, a4, a5, a6, a7, a8;
   mp_int b0, b1, b2, b3, b4, b5, b6, b7, b8;
   mp_err err = MP_OKAY;
   int B;

   B = a->used / 9;

   if ((err = mp_init_multi(&S1, &S2, &S3, &S4, &S5, &S6, &S7, &S8, &S9, &S10, &S11, &S12, &S13, &S14, &S15,
                            &S16, &S17, &t, NULL)) != MP_OKAY) {
      return err;
   }
   ...
   if ((err = mp_init_size(&b6, B)) != MP_OKAY)                                                          goto LTM_ERRb6;
   if ((err = mp_init_size(&b7, B)) != MP_OKAY)                                                          goto LTM_ERRb7;
   if ((err = mp_init_size(&b8, b->used - 8 * B)) != MP_OKAY)                                            goto LTM_ERRb8;
   ...
   /* B = b0 * x^0 + b1 * x^1 + b2 * x^2 + b3 * x^3  + b4 * x^4 + b5 * x^5 + b6 * x^6 + b7 * x^7+ b8 * x^8; */
   b0.used = b1.used = b2.used = b3.used = b4.used = b5.used = b6.used = b7.used = B;
   b8.used = b->used - 8 * B;
   ...
   s_mp_copy_digs(b7.dp, b->dp + 7 * B, b7.used);
   s_mp_copy_digs(b8.dp, b->dp + 8 * B, b8.used);
   mp_clamp(&b0);
   mp_clamp(&b1);
   mp_clamp(&b2);
   mp_clamp(&b3);
   ...
   /** S1 = S1 + b8; */
   if ((err = mp_add(&S1, &b8, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S17 = b1 + b3; */
   if ((err = mp_add(&b1, &b3, &S17)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S17 = S17 + b5; */
   if ((err = mp_add(&S17, &b5, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17 + b7; */
   if ((err = mp_add(&S17, &b7, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S4 = S1 - S17; */
   if ((err = mp_sub(&S1, &S17, &S4)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S5 = S1 + S17; */
   if ((err = mp_add(&S1, &S17, &S5)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S6 = S2 * S4; */
   if ((err = mp_mul(&S2, &S4, &S6)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S7 = S3 * S5; */
   if ((err = mp_mul(&S3, &S5, &S7)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S1 = a0<<4; */
   ...
   if ((err = mp_add(&S1, &b8, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S17 = b1<<4; */
   if ((err = mp_mul_2d(&b1, 4, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17 + b3; */
   if ((err = mp_add(&S17, &b3, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17<<4; */
   if ((err = mp_mul_2d(&S17, 4, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S17 = S17 + b5; */
   if ((err = mp_add(&S17, &b5, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   ...
   if ((err = mp_mul_2d(&S17, 2, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S13 = S1 - S17; */
   if ((err = mp_sub(&S1, &S17, &S13)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S14 = S1 + S17; */
   if ((err = mp_add(&S1, &S17, &S14)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S4 = S2 * S13; */
   if ((err = mp_mul(&S2, &S13, &S4)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S9 = S3 * S14; */
   if ((err = mp_mul(&S3, &S14, &S9)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S1 = a0<<2; */
   ...
   if ((err = mp_add(&S1, &b8, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S17 = b1<<2; */
   if ((err = mp_mul_2d(&b1, 2, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17 + b3; */
   if ((err = mp_add(&S17, &b3, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17<<2; */
   if ((err = mp_mul_2d(&S17, 2, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   ...
   if ((err = mp_add(&S1, &S17, &S14)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S5 = S11 * S13; */
   if ((err = mp_mul(&S11, &S13, &S5)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S8 = S12 * S14; */
   if ((err = mp_mul(&S12, &S14, &S8)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S1 = a0<<6; */
   ...
   /** S1 = b0<<6; */
   if ((err = mp_mul_2d(&b0, 6, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S1 = S1 + b2; */
   if ((err = mp_add(&S1, &b2, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S1 = S1<<6; */
   if ((err = mp_mul_2d(&S1, 6, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   ...
   if ((err = mp_add(&S1, &b8, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S17 = b1<<6; */
   if ((err = mp_mul_2d(&b1, 6, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17 + b3; */
   if ((err = mp_add(&S17, &b3, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17<<6; */
   if ((err = mp_mul_2d(&S17, 6, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   ...
   /** S3 = S12 * S14; */
   if ((err = mp_mul(&S12, &S14, &S3)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S2 = S13 * S15; */
   if ((err = mp_mul(&S13, &S15, &S2)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S1 = a8<<2; */
   ...
   if ((err = mp_add(&S1, &S17, &S13)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S1 = b8<<2; */
   if ((err = mp_mul_2d(&b8, 2, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S1 = S1 + b6; */
   if ((err = mp_add(&S1, &b6, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S1 = S1<<2; */
   if ((err = mp_mul_2d(&S1, 2, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   ...
   /** S17 = b7<<2; */
   if ((err = mp_mul_2d(&b7, 2, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17 + b5; */
   if ((err = mp_add(&S17, &b5, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17<<2; */
   if ((err = mp_mul_2d(&S17, 2, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   ...
   if ((err = mp_mul_2d(&S17, 2, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S17 = S17 + b1; */
   if ((err = mp_add(&S17, &b1, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17<<1; */
   if ((err = mp_mul_2d(&S17, 1, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S14 = S1 - S17; */
   if ((err = mp_sub(&S1, &S17, &S14)) != MP_OKAY)                                                       goto LTM_ERR;
   ...
   if ((err = mp_add(&S1, &S17, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S10 = S12 * S14; */
   if ((err = mp_mul(&S12, &S14, &S10)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S11 = S13 * S15; */
   if ((err = mp_mul(&S13, &S15, &S11)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S1 = a8<<4; */
   ...
   if ((err = mp_add(&S1, &S17, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S1 = b8<<4; */
   if ((err = mp_mul_2d(&b8, 4, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S1 = S1 + b6; */
   if ((err = mp_add(&S1, &b6, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S1 = S1<<4; */
   if ((err = mp_mul_2d(&S1, 4, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   ...
   if ((err = mp_add(&S1, &b0, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S17 = b7<<4; */
   if ((err = mp_mul_2d(&b7, 4, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17 + b5; */
   if ((err = mp_add(&S17, &b5, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17<<4; */
   if ((err = mp_mul_2d(&S17, 4, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   ...
   if ((err = mp_mul_2d(&S17, 2, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S16 = S1 - S17; */
   if ((err = mp_sub(&S1, &S17, &S16)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S1 + S17; */
   if ((err = mp_add(&S1, &S17, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S12 = S14 * S16; */
   if ((err = mp_mul(&S14, &S16, &S12)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S13 = S15 * S17; */
   if ((err = mp_mul(&S15, &S17, &S13)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S1 = a8<<6; */
   ...
   /** S1 = b8<<6; */
   if ((err = mp_mul_2d(&b8, 6, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S1 = S1 + b6; */
   if ((err = mp_add(&S1, &b6, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S1 = S1<<6; */
   if ((err = mp_mul_2d(&S1, 6, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   ...
   if ((err = mp_add(&S1, &b0, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S17 = b7<<6; */
   if ((err = mp_mul_2d(&b7, 6, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17 + b5; */
   if ((err = mp_add(&S17, &b5, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17<<6; */
   if ((err = mp_mul_2d(&S17, 6, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   ...
   if ((err = mp_sub(&S1, &S17, &S14)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S14 = S15 * S14; */
   if ((err = mp_mul(&S15, &S14, &S14)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S1 = S1 + S17; */
   if ((err = mp_add(&S1, &S17, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S15 = S16 * S1; */
   if ((err = mp_mul(&S16, &S1, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S1 = a8<<4; */
   if ((err = mp_mul_2d(&a8, 4, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S1 = S1 + a7; */
   ...
   if ((err = mp_add(&S1, &a0, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S17 = b8<<4; */
   if ((err = mp_mul_2d(&b8, 4, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17 + b7; */
   if ((err = mp_add(&S17, &b7, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17<<4; */
   if ((err = mp_mul_2d(&S17, 4, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S17 = S17 + b6; */
   if ((err = mp_add(&S17, &b6, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17<<4; */
   if ((err = mp_mul_2d(&S17, 4, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S17 = S17 + b5; */
   if ((err = mp_add(&S17, &b5, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   ...
   if ((err = mp_mul_2d(&S17, 4, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S17 = S17 + b4; */
   if ((err = mp_add(&S17, &b4, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17<<4; */
   if ((err = mp_mul_2d(&S17, 4, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S17 = S17 + b3; */
   if ((err = mp_add(&S17, &b3, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   ...
   if ((err = mp_mul_2d(&S17, 4, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S17 = S17 + b2; */
   if ((err = mp_add(&S17, &b2, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S17 = S17<<4; */
   if ((err = mp_mul_2d(&S17, 4, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S17 = S17 + b1; */
   if ((err = mp_add(&S17, &b1, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   ...
   if ((err = mp_mul_2d(&S17, 4, &S17)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S17 = S17 + b0; */
   if ((err = mp_add(&S17, &b0, &S17)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S16 = S1 * S17; */
   if ((err = mp_mul(&S1, &S17, &S16)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S1 = a0 * b0; */
   if ((err = mp_mul(&a0, &b0, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S17 = a8 * b8; */
   if ((err = mp_mul(&a8, &b8, &S17)) != MP_OKAY)                                                        goto LTM_ERR;
