...
#ifdef S_MP_MUL_TOOM_8_C
/* LibTomMath, multiple-precision integer library -- Tom St Denis */
/* SPDX-License-Identifier: Unlicense */


mp_err s_mp_mul_toom_8(const mp_int *a, const mp_int *b,  mp_int *c)
{
   mp_int S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13, S14, S15, t;
   mp_int a0, a1, a2, a3, a4, a5, a6, a7;
   mp_int b0, b1, b2, b3, b4, b5, b6, b7;
   mp_err err = MP_OKAY;
   int B;
   ...
   if ((err = mp_init_size(&b7, b->used - 7 * B)) != MP_OKAY)                                            goto LTM_ERRb7;
   ...
   /* B = b0 * x^0 + b1 * x^1 + b2 * x^2 + b3 * x^3  + b4 * x^4 + b5 * x^5 + b6 * x^6 + b7 * x^7; */
   b0.used = b1.used = b2.used = b3.used = b4.used = b5.used = b6.used =B;
   b7.used = b->used - 7 * B;
   ...
   /** S15 = b1 + b3; */
   if ((err = mp_add(&b1, &b3, &S15)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S15 = S15 + b5; */
   if ((err = mp_add(&S15, &b5, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15 + b7; */
   if ((err = mp_add(&S15, &b7, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S7 = S1 - S15; */
   if ((err = mp_sub(&S1, &S15, &S7)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S8 = S1 + S15; */
   if ((err = mp_add(&S1, &S15, &S8)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S5 = S2 * S7; */
   if ((err = mp_mul(&S2, &S7, &S5)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S6 = S3 * S8; */
   if ((err = mp_mul(&S3, &S8, &S6)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S1 = a0<<4; */
   ...
   if ((err = mp_mul_2d(&S1, 2, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S15 = b1<<4; */
   if ((err = mp_mul_2d(&b1, 4, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15 + b3; */
   if ((err = mp_add(&S15, &b3, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15<<4; */
   if ((err = mp_mul_2d(&S15, 4, &S15)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S15 = S15 + b5; */
   if ((err = mp_add(&S15, &b5, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   ...
   /** S3 = S11 * S13; */
   if ((err = mp_mul(&S11, &S13, &S3)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S8 = S12 * S14; */
   ...
   if ((err = mp_mul_2d(&S1, 1, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S15 = b1<<2; */
   if ((err = mp_mul_2d(&b1, 2, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15 + b3; */
   if ((err = mp_add(&S15, &b3, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15<<2; */
   if ((err = mp_mul_2d(&S15, 2, &S15)) != MP_OKAY)                                                      goto LTM_ERR;
   ...
   if ((err = mp_add(&S1, &S15, &S14)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S4 = S11 * S13; */
   if ((err = mp_mul(&S11, &S13, &S4)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S7 = S12 * S14; */
   if ((err = mp_mul(&S12, &S14, &S7)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S1 = a6<<2; */
   ...
   /** S15 = b7<<2; */
   if ((err = mp_mul_2d(&b7, 2, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15 + b5; */
   if ((err = mp_add(&S15, &b5, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15<<2; */
   if ((err = mp_mul_2d(&S15, 2, &S15)) != MP_OKAY)                                                      goto LTM_ERR;
   ...
   if ((err = mp_mul_2d(&S15, 2, &S15)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S15 = S15 + b1; */
   if ((err = mp_add(&S15, &b1, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15<<1; */
   if ((err = mp_mul_2d(&S15, 1, &S15)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S13 = S1 + S15; */
   ...
   /** S9 = S12 * S14; */
   if ((err = mp_mul(&S12, &S14, &S9)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S10 = S11 * S13; */
   if ((err = mp_mul(&S11, &S13, &S10)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S1 = a6<<4; */
   ...
   if ((err = mp_add(&S1, &b0, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S15 = b7<<4; */
   if ((err = mp_mul_2d(&b7, 4, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15 + b5; */
   if ((err = mp_add(&S15, &b5, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15<<4; */
   if ((err = mp_mul_2d(&S15, 4, &S15)) != MP_OKAY)                                                      goto LTM_ERR;
   ...
   if ((err = mp_sub(&S1, &S15, &S11)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S12 = S13 * S12; */
   if ((err = mp_mul(&S13, &S12, &S12)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S11 = S14 * S11; */
   if ((err = mp_mul(&S14, &S11, &S11)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S1 = a6<<6; */
   ...
   if ((err = mp_add(&S1, &b0, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S15 = b7<<6; */
   if ((err = mp_mul_2d(&b7, 6, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15 + b5; */
   if ((err = mp_add(&S15, &b5, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15<<6; */
   if ((err = mp_mul_2d(&S15, 6, &S15)) != MP_OKAY)                                                      goto LTM_ERR;
   ...
   if ((err = mp_mul_2d(&S15, 3, &S15)) != MP_OKAY)                                                      goto LTM_ERR;
   /** S2 = S1 + S15; */
   if ((err = mp_add(&S1, &S15, &S2)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S14 = S14 * S2; */
   if ((err = mp_mul(&S14, &S2, &S14)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S2 = S1 - S15; */
   if ((err = mp_sub(&S1, &S15, &S2)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S13 = S13 * S2; */
   if ((err = mp_mul(&S13, &S2, &S13)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S1 = a0<<6; */
   ...
   if ((err = mp_mul_2d(&S1, 3, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S15 = b1<<6; */
   if ((err = mp_mul_2d(&b1, 6, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15 + b3; */
   if ((err = mp_add(&S15, &b3, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S15 = S15<<6; */
   if ((err = mp_mul_2d(&S15, 6, &S15)) != MP_OKAY)                                                      goto LTM_ERR;
   ...
   if ((err = mp_add(&S15, &b7, &S15)) != MP_OKAY)                                                       goto LTM_ERR;
   /** S1 = S1 - S15; */
   if ((err = mp_sub(&S1, &S15, &S1)) != MP_OKAY)                                                        goto LTM_ERR;
   /** S2 = S1 * S2; */
   if ((err = mp_mul(&S1, &S2, &S2)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S1 = a0 * b0; */
   if ((err = mp_mul(&a0, &b0, &S1)) != MP_OKAY)                                                         goto LTM_ERR;
   /** S15 = a7 * b7; */
   if ((err = mp_mul(&a7, &b7, &S15)) != MP_OKAY)                                                        goto LTM_ERR;
