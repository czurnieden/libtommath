...
mp_set_l.o mp_set_u32.o mp_set_u64.o mp_set_ul.o mp_shrink.o mp_signed_rsh.o mp_small_prime_sieve_clear.o \
mp_small_prime_sieve_init.o mp_small_prime_sieve_is_small_prime.o mp_small_prime_sieve_next_prime.o \
mp_small_prime_sieve_prec_prime.o mp_sqrmod.o mp_sqrt.o mp_sqrtmod_prime.o mp_sub.o mp_sub_d.o mp_submod.o \
mp_to_radix.o mp_to_sbin.o mp_to_ubin.o mp_ubin_size.o mp_unpack.o mp_warray_free.o mp_xor.o mp_zero.o \
s_mp_add.o s_mp_copy_digs.o s_mp_div_3.o s_mp_div_recursive.o s_mp_div_school.o s_mp_div_small.o \
...
s_mp_rand_platform.o s_mp_rand_source.o s_mp_small_prime_sieve.o s_mp_sqr.o s_mp_sqr_comba.o \
