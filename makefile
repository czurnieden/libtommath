...
s_mp_mul_toom.o s_mp_mul_toom_4.o s_mp_mul_toom_5.o s_mp_prime_is_divisible.o s_mp_prime_tab.o \
s_mp_radix_map.o s_mp_radix_size_overestimate.o s_mp_rand_platform.o s_mp_sqr.o s_mp_sqr_comba.o \
s_mp_sqr_karatsuba.o s_mp_sqr_toom.o s_mp_sqr_toom_4.o s_mp_sqr_toom_5.o s_mp_sub.o s_mp_zero_buf.o \
s_mp_zero_digs.o
