...
s_mp_exptmod_fast.o s_mp_fp_exp2.o s_mp_fp_log.o s_mp_fp_log_d.o s_mp_fprint.o s_mp_get_bit.o \
...
s_mp_mul_toom.o s_mp_parse_printf_token.o s_mp_prime_is_divisible.o s_mp_prime_tab.o s_mp_radix_map.o \
s_mp_radix_size_overestimate.o s_mp_rand_platform.o s_mp_rand_source.o s_mp_root_n.o s_mp_set_bit.o \
s_mp_set_word.o s_mp_small_prime_sieve.o s_mp_sprint.o s_mp_sqr.o s_mp_sqr_comba.o s_mp_sqr_karatsuba.o \
s_mp_sqr_toom.o s_mp_sqrt_w.o s_mp_sub.o s_mp_warray.o s_mp_warray_get.o s_mp_warray_put.o s_mp_zero_buf.o \
s_mp_zero_digs.o
